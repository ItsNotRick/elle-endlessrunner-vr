...
class ENDLESSRUNNERVR_API UFileDownloader : public UObject
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	UFileDownloader* DownloadFile(FString SavePath, FString FileName, FString access_token, int deckID);

private:
	FHttpModule * Http;
	FString ApiBaseUrl = "https://endlesslearner.com/";
